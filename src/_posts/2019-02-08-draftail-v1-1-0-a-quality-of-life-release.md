...
date: 2019-02-08 16:01:24 +0200
comments: true
categories: [Wagtail, Draftjs, Draftail, Tools]
canonical: https://www.draftail.org/blog/2019/02/08/draftail-v1-1-0-a-quality-of-life-release
---
...
This release comes with a new feature – support for [form validation](https://www.draftail.org/docs/form-validation) (and more), with [`onFocus`](https://www.draftail.org/docs/api#managing-focus) and [`onBlur`](https://www.draftail.org/docs/api#managing-focus) props for the editor. Thanks to [@TheSpicyMeatball](https://github.com/TheSpicyMeatball) for making this happen.
...
[![Screenshot of the draftail.org homepage](/images/blog/draftail-v1-1-0-a-quality-of-life-release/draftail-dot-org-screenshot.png)](https://www.draftail.org/)
...
[![Screenshot of Storybook for Draftail, with the stories menu shown on the left side, and the "UI theming" story active on the right. This story shows the editor with a custom "focus mode" UI theme](/images/blog/draftail-v1-1-0-a-quality-of-life-release/storybook-example.png)](https://demo.draftail.org/storybook/?selectedKind=Docs&selectedStory=UI%20theming)
